      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="flex items-center justify-between sm:items-stretch w-full">
          ...
          <div class="flex items-center">
            ...
            <span v-if="user.name" class="hidden sm:block text-sm text-gray-700 mr-4">{{ user.name }}</span>
            <button @click="logout" class="px-4 py-2 bg-gray-900 text-white rounded">
              <span class="hidden sm:inline">Logout</span>
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:hidden" viewBox="0 0 24 24" fill="none"
                stroke="currentColor">
