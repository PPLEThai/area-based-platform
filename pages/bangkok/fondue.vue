...
const addMapLayers = (map, data) => {
  ...
  map.on("click", "traffy-layer", (e) => {
    ...
    const problemTypeArray =
      typeof problemTypeValue === "string"
    ...
    const popupContent = `
            <div class="p-4">
                ...
                ${
                  photoUrl
                    ? `<img src="${photoUrl}" alt="รูปภาพปัญหา" class="w-full h-auto mt-4 rounded shadow-lg">`
                    : ""
                }
            </div>
        `;
